        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Henyelrey/SysAdmin.git'
                }
            }
        }
        stage('Build') {
