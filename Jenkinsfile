        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/Henyelrey/SysAdmin.git'
                }
            }
        }
        stage('Build') {
